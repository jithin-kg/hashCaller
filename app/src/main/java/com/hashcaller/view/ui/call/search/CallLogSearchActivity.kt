...
import com.hashcaller.databinding.ActivityCallLogSearchBinding
...
import com.hashcaller.view.ui.contacts.isDarkThemeOn
import com.hashcaller.view.ui.contacts.makeCall
import com.hashcaller.view.ui.sms.individual.util.TYPE_MAKE_CALL
import com.hashcaller.view.ui.sms.individual.util.UNMARK_ITEM
...
import com.hashcaller.view.ui.sms.util.ITextChangeListener
import com.hashcaller.view.ui.sms.util.TextChangeListener
...
class CallLogSearchActivity : AppCompatActivity(), CallSearchAdapter.ViewMarkHandler,
    ...
    private fun startIndividualContactActivity(log: CallLogTable, view: View) {
        ...
        intent.putExtra(com.hashcaller.view.ui.contacts.utils.CONTACT_ID, log.number)
