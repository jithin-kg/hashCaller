package com.hashcaller.view.ui.sms.individual.util
...
open class BaseConfig(val context: Context) {
    ...
    var textColor: Int
        get() = prefs.getInt(TEXT_COLOR, context.resources.getColor(R.color.textColor))
    ...
    var appIconColor: Int
        get() = prefs.getInt(APP_ICON_COLOR, context.resources.getColor(R.color.colorPrimary))
        set(appIconColor) {
            isUsingModifiedAppIcon = appIconColor != context.resources.getColor(R.color.colorPrimary)
            prefs.edit().putInt(APP_ICON_COLOR, appIconColor).apply()
        }

    var lastIconColor: Int
        get() = prefs.getInt(LAST_ICON_COLOR, context.resources.getColor(R.color.colorPrimary))
    ...
    var lastUsedViewPagerPage: Int
        get() = prefs.getInt(LAST_USED_VIEW_PAGER_PAGE, context.resources.getInteger(0))
