...
class SMSSearchContactAdapter(private val context: Context, private val onContactItemClickListener: (binding: ContactSearchResultItemBinding, contactItem: Contact, clickType:Int)->Unit) :
