package com.hashcaller.view.ui.contactSelector
...
import com.hashcaller.work.DESTINATION_ACTIVITY
import com.hashcaller.work.INDIVIDUAL_SMS_ACTIVITY
...
//            contactsRecyclerAdapter = ContactAdapter(context) { id: com.hashcaller.network.user.Contact ->onContactItemClicked(id)}
