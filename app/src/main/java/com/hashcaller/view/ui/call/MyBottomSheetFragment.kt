 ...
 * <pre>
 *    MyBottomSheetFragment.newInstance(30).show(supportFragmentManager, "dialog")
 * </pre>
 */
class MyBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_my_bottom_sheet_list_dialog, container, false)
    }
    ...
    private inner class ViewHolder internal constructor(
        ...
        inflater.inflate(
            R.layout.fragment_my_bottom_sheet_list_dialog_item,
            parent,
            false
        )
    ) {
    ...
    companion object {
        ...
        fun newInstance(itemCount: Int): MyBottomSheetFragment =
