...
import com.hashcaller.stubs.SimAndNumberDTO
import com.hashcaller.utils.Constants
import com.hashcaller.utils.NotificationHelper
import com.hashcaller.utils.callReceiver.InCommingCallManager
import com.hashcaller.utils.callReceiver.InCommingCallManager.Companion.REASON_BLOCK_BY_PATTERN
import com.hashcaller.utils.callReceiver.InCommingCallManager.Companion.REASON_BLOCK_NON_CONTACT
import com.hashcaller.utils.callReceiver.InCommingCallManager.Companion.REASON_BLOCK_TOP_SPAMMER
import com.hashcaller.utils.constants.IntentKeys
import com.hashcaller.utils.constants.IntentKeys.Companion.CALL_HANDLED_SIM
import com.hashcaller.utils.constants.IntentKeys.Companion.CALL_HANDLED_STATE
import com.hashcaller.utils.constants.IntentKeys.Companion.CALL_STATE
import com.hashcaller.utils.constants.IntentKeys.Companion.CARRIER
import com.hashcaller.utils.constants.IntentKeys.Companion.COUNTRY
import com.hashcaller.utils.constants.IntentKeys.Companion.FIRST_NAME
import com.hashcaller.utils.constants.IntentKeys.Companion.INTENT_COMMAND
import com.hashcaller.utils.constants.IntentKeys.Companion.LAST_NAME
import com.hashcaller.utils.constants.IntentKeys.Companion.LOCATION
import com.hashcaller.utils.constants.IntentKeys.Companion.PHONE_NUMBER
import com.hashcaller.utils.constants.IntentKeys.Companion.SHOW_FEEDBACK_VIEW
import com.hashcaller.utils.constants.IntentKeys.Companion.SPAM_COUNT
import com.hashcaller.utils.constants.IntentKeys.Companion.START_FLOATING_SERVICE
import com.hashcaller.utils.constants.IntentKeys.Companion.START_FLOATING_SERVICE_FROM_SCREENING_SERVICE
import com.hashcaller.utils.constants.IntentKeys.Companion.START_FLOATING_SERVICE_OFF_HOOK
import com.hashcaller.utils.constants.IntentKeys.Companion.STATUS_CODE
import com.hashcaller.utils.constants.IntentKeys.Companion.STOP_FLOATING_SERVICE
import com.hashcaller.utils.constants.IntentKeys.Companion.STOP_FLOATING_SERVICE_AND_WINDOW
import com.hashcaller.utils.constants.IntentKeys.Companion.STOP_FLOATING_SERVICE_FROM_INCOMMING_ACTVTY
import com.hashcaller.utils.constants.IntentKeys.Companion.UPDATE_INCOMMING_VIEW
import com.hashcaller.utils.notifications.blockPreferencesDataStore
import com.hashcaller.view.ui.IncommingCall.ActivityIncommingCallView
import com.hashcaller.view.ui.call.dialer.util.CallLogLiveData
import com.hashcaller.view.ui.call.floating.FloatingService
import com.hashcaller.view.ui.contacts.individualContacts.IndividualContactViewActivity
import com.hashcaller.view.ui.contacts.utils.CONTACT_ADDRES
import com.hashcaller.view.ui.contacts.utils.ContactLiveData
import com.hashcaller.view.ui.contacts.utils.QUERY_STRING
...
import com.hashcaller.view.ui.sms.search.SearchSMSActivity
import com.hashcaller.view.ui.sms.util.SMSContract
import com.hashcaller.view.utils.SIMAccount
import com.hashcaller.work.SpamReportWorker
...
fun Context.onContactItemClicked(binding: ContactListBinding, contactItem: Contact,activity:Activity? ){
    ...
    intent.putExtra(com.hashcaller.view.ui.contacts.utils.CONTACT_ID, contactItem.phoneNumber)
